...
export default function EnLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(false)
    alert(isRegister ? 'Registration requires backend support' : 'Login requires backend support')
  }
          ...
          <div className="card">
            <div className="text-center mb-8">
              ...
              <p className="text-sm text-text-dim">
                {isRegister
                  ? 'Join TaZhaShuo and start conversing with great minds'
                  : 'Sign in to continue your mind journey'}
              </p>
            </div>
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="px-3 bg-[#0a0a12] text-text-muted">Or use email</span>
              </div>
            </div>
